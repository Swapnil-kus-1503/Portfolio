      ...
      <Introduction>
        ...
        <div className="image-cropper"></div>
          <div className="profile-text">
            ...
            <h1>Swapnil&nbsp;Kushwaha</h1>
          </div>
        </ProfileCard>
        <div className="short">Aspired to be full stack web developer. Passionate about building digital products that improve everyday experience for people.
        </div>
        ...
        <Social>
          ...
          <div className="iconcontainer">
            <a
              className="same"
              href="mailto:ashukushwaha15031997@gmail.com"
              target="_blank"
              rel="noopener noreferrer"
